...
df = pd.read_excel("/home/hajun/kaqu_llm/src/llm_destination/llm_destination/room_coordinates.xlsx")
...
class DestinationPublisher(Node):
    def __init__(self):
        ...
        self.subscription = self.create_subscription(String, 'STT_topic', self.stt_callback, 10)
